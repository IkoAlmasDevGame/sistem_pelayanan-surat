...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="?page=formulir" aria-current="page">
                <i class="bi bi-book has-icon"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="?page=cetak" aria-current="page">
                <i class="bi bi-download has-icon"></i>
